...
public class PaymentConfiguration {
    ...
    public init(publicId: String, paymentData: PaymentData, delegate: PaymentDelegate? = nil, uiDelegate: PaymentUIDelegate? = nil, scanner: PaymentCardScanner? = nil,
                requireEmail: Bool = false, useDualMessagePayment: Bool = false, disableApplePay: Bool = false, apiUrl: String = "https://api.cloudpayments.ru/", successRedirectUrl: String? = nil, failRedirectUrl: String? = nil, saveCardForSinglePaymentMode: Bool? = nil) {
        ...
        self.saveCardForSinglePaymentMode = saveCardForSinglePaymentMode
    }
}
